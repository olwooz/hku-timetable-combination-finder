            ...
            <div className="courses">
                <ul className="courses-wrapper">
                    <li className="courses-group">
                        <div className="top-info"><span>SUN</span></div>
                        <ul>
                            {courses.map((course, idx)=>{
                                if (course.day.includes("SUN")) {
                                    ...
                                    return (
                                    <li key={idx} style={style} className={`course-${idx+1}`} data-start={course.stime[i]} data-end={course.etime[i]} data-content={`course-${course.code}`} data-event={`course-${idx+1}`}>
                                        <span style={{lineHeight: spanHeight}}className="coursetext">{course.code + " " + course.section}<br />{course.stime[i] + "-" + course.etime[i]}</span>
                                    </li>);
                                }
                            })}
                        </ul>
                    ...
                    <li className="courses-group">
                        <div className="top-info"><span>MON</span></div>
                        <ul>
                            {courses.map((course, idx)=>{
                    ...
                    <li className="courses-group">
                        <div className="top-info"><span>TUE</span></div>
                        <ul>
                            {courses.map((course, idx)=>{
                    ...
                    <li className="courses-group">
                        <div className="top-info"><span>WED</span></div>
                        <ul>
                            {courses.map((course, idx)=>{
                    ...
                    <li className="courses-group">
                        <div className="top-info"><span>THU</span></div>
                        <ul>
                            {courses.map((course, idx)=>{
                    ...
                    <li className="courses-group">
                        <div className="top-info"><span>FRI</span></div>
                        <ul>
                            {courses.map((course, idx)=>{
                    ...
                    <li className="courses-group">
                        <div className="top-info"><span>SAT</span></div>
                        <ul>
                            {courses.map((course, idx)=>{
